...
<!-- Expand with: email, files, databases, line-of-business application data, cloud data (M365 data needs backup too) -->

## The 3-2-1 Backup Rule

<!-- Expand with: 3 copies, 2 different media, 1 off-site — and why cloud backup satisfies the off-site requirement -->

## RTO and RPO: The Two Numbers Every Business Owner Should Know

<!-- Expand with: plain language explanation, how to calculate what your business can tolerate -->

## Why Cloud Sync Is Not a Backup

<!-- Expand with: OneDrive/Google Drive sync is not backup — deletions sync, ransomware encryption syncs -->

## How to Make Your Backups Ransomware-Proof

<!-- Expand with: immutable storage, air-gapped copies, off-network storage -->

## How to Test Your Backups

<!-- Expand with: quarterly test restore process, what to check, common failure modes -->
