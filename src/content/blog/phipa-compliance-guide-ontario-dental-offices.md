...
<!-- Expand with: definition of health information custodian, scope of PHI, RCDSO overlap -->

## What PHIPA Requires from Your IT Systems

<!-- Expand with: access controls, encryption at rest and in transit, audit logging, breach response plan -->

## The Five Most Common PHIPA IT Violations in Dental Offices

<!-- Expand with: shared logins, unencrypted backups, consumer-grade email, no audit logs, no breach plan -->

## What a PHIPA-Compliant IT Setup Looks Like

<!-- Expand with: concrete technical controls for a typical dental practice -->

## What to Do if You Have a Data Breach

<!-- Expand with: containment, assessment, mandatory notification requirements under PHIPA -->
