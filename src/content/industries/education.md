...
features:
  ...
  - name: "Classroom Technology Management"
    description: "Setup, management, and support for interactive displays, projectors, tablets, and classroom computing devices."
...
faqs:
  - question: "What privacy obligations do private schools have regarding student data in Ontario?"
    answer: "Private schools in Ontario that collect personal information about students and families are subject to PIPEDA (federal privacy law) and may also be subject to FIPPA (Freedom of Information and Protection of Privacy Act) depending on their structure and funding. These laws require reasonable safeguards to protect personal information, a documented privacy policy, and mandatory breach reporting. WiseTech helps educational institutions implement and document the IT controls needed to meet these obligations."
  - question: "Do you support Google Workspace for Education or Microsoft 365 for Education?"
    answer: "Yes. WiseTech configures and manages both Google Workspace for Education and Microsoft 365 for Education environments, including user provisioning for staff and students, security policy configuration, and ongoing administration. Both platforms offer education-specific licensing and features that WiseTech can help your institution access and configure appropriately."
...
Educational institutions collect significant personal information about students and their families: names, contact details, academic records, health information for accommodation purposes, and payment data. This information must be protected in accordance with applicable privacy legislation, and the families who entrust you with it have a reasonable expectation that it will be handled responsibly.

WiseTech implements access controls that ensure staff can only access the student records relevant to their role, encrypts sensitive data at rest and in transit, and provides the documentation your institution needs to demonstrate responsible data governance.
...
If your institution provides devices to students or operates a bring-your-own-device programme, WiseTech can implement mobile device management that enforces security policies, manages updates, and allows remote support. Content filtering on student-facing networks and devices meets your duty-of-care obligations and keeps students focused on learning rather than inappropriate content.
